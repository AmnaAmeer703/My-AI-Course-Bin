...
st.title("🚦 Traffic Violation Detection using YOLO11")
...
DETECTION_MODEL = ROOT / "best (1).pt"
SEGMENTATION_MODEL = WEIGHTS_DIR / "yolo11n-seg.pt"
POSE_MODEL = WEIGHTS_DIR / "yolo11n-pose.pt"
