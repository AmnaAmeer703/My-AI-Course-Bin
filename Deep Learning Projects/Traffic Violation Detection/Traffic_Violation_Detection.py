...
metrics_path = '/kaggle/working/runs/detect/Traffic_Violation/Traffic_Violation_Detection/results.png'
cm_path = '/kaggle/working/runs/detect/traffic_violation_detection/yolo8_train/confusion_matrix.png'
...
metrics_path = '/kaggle/working/runs/detect/Traffic_Violation/Traffic_Violation_Detection/results.png'
cm_path = '/kaggle/working/runs/detect/Traffic_Violation/Traffic_Violation_Detection/confusion_matrix.png'
...
FileLink(r'runs/detect/Traffic_Violation/Traffic_Violation_Detection/weights/best.pt')

FileLink(r'runs/detect/Traffic_Violation/Traffic_Violation_Detection/weights/best.onnx')
