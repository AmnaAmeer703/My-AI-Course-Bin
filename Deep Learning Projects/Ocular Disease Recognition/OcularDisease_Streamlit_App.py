...
st.header("Ocular Disease Recognition App")
st.caption("Upload an image. ")
st.caption("The application will infer the one label out of 4 labels: cataract,diabetic_retionpathy,glaucoma,normal")
...
class_name = {'cataract': 0, 'diabetic_retinopathy': 1, 'glaucoma': 2, 'normal': 3}
