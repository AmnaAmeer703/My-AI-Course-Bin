...
st.header("Skin Cancer Image Recognition App")
st.caption("Upload an image. ")
st.caption("The application will infer the one label out of 7 labels: benign keratosis,melanocytic,melanoma,basal cell carcinoma,Bowens diease,vascular lesions,dermatofibroma")
...
class_names = ['benign keratosis','melanocytic','melanoma','basal cell carcinoma','Bowens diease','vascular lesions','dermatofibroma']
...
def predict_label(image2):
    imgLoaded = load_img(image2, target_size=(128, 128))
